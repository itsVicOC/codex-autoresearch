...
- Los hooks de `foreground` funcionan mejor con el layout interactivo predeterminado de artifacts; los overrides ad-hoc de rutas en foreground todavia pueden quedar en no-op.
